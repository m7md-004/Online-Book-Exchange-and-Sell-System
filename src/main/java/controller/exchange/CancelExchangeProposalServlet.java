...
@WebServlet("/secure/exchange/cancel")
public class CancelExchangeProposalServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean ok = dao.cancelExchangeProposal(proposalId, u.getId());

            if (!ok) {
                response.sendError(403, "Not allowed or cannot cancel this proposal.");
                return;
            }
