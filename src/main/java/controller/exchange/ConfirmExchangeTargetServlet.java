...
@WebServlet("/secure/exchange/confirm-target")
public class ConfirmExchangeTargetServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        int proposalId;
        try {
            proposalId = Integer.parseInt(idStr);
        ...
        try {
            ...
            boolean ok = dao.confirmExchangeAsTargetOwner(proposalId, u.getId());
